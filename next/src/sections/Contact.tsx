          ...
          <div className="relative card-glass p-8 sm:p-12 md:p-16">
            ...
            <div className="flex justify-center mb-12">
              <motion.a
                ...
                whileTap={{ scale: 0.98 }}
                className="card-glass p-8 text-center group max-w-md w-full"
              >
                <div className="w-16 h-16 bg-accent/20 rounded-2xl flex items-center justify-center mb-6 group-hover:bg-accent/30 transition-colors mx-auto">
                  <svg
                ...
                <h3 className="text-2xl font-semibold text-white mb-3">LinkedIn</h3>
                <p className="text-light-100">Connect with me professionally</p>
              </motion.a>
            </div>
