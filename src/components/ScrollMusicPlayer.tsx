...
const ScrollMusicPlayerComponent = ({ track, isActive, index, onBecomeActive }: ScrollMusicPlayerProps) => {
  ...
  return (
    <motion.div
      ...
      className="relative min-h-screen sm:min-h-[120vh] md:min-h-[140vh] px-3 sm:px-4 overflow-hidden"
    ...
    >
      ...
      <div className="sticky top-1/2 -translate-y-1/2 max-w-4xl w-full mx-auto relative z-10">
        <audio
          ref={audioRef}
          src={track.audioPath}
          loop
          ...
          >
            ...
            <div className="p-4 sm:p-6 md:p-8">
              ...
              >
                ...
                <p className="text-base sm:text-lg text-light-100 mb-3 sm:mb-4">
                  {track.artist}
                </p>

                <p className="text-sm sm:text-base text-light-100/70 mb-4 sm:mb-6 leading-relaxed">
                  {track.description}
                </p>
